...
const ClusterConnectionForm: React.FC<ClusterConnectionFormProps> = ({
  ...
  const { createCluster, updateCluster, testConnection, testNewConnection } =
    useClusters();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      success(
        `Cluster connection "${savedCluster.name}" ${
      ...
      if (err.response?.status === 409) {
        errorMessage =
          "A cluster connection with this name already exists. Please choose a different name.";
        ...
        errorMessage =
          ...
          } cluster connection. Please try again.`;
      }
      ...
      <DialogContent>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3, pt: 1 }}>
          ...
          <TextField
            ...
            error={!!errors.name}
            helperText={
              errors.name || "A descriptive name for this cluster connection"
            }
            fullWidth
            required
          />
          ...
          <TextField
            ...
            helperText={
              errors.apiUrl ||
              "e.g., http://localhost:15672 or https://rabbitmq.example.com:15672"
            }
            fullWidth
            required
          ...
          <TextField
            ...
            helperText={
              errors.description ||
              "Optional description for this cluster connection"
            }
            fullWidth
            multiline
            rows={2}
          ...
          >
            ...
            {!testResult && (
              <Typography variant="body2" color="text.secondary">
                Test the connection to ensure the RabbitMQ Management API is
